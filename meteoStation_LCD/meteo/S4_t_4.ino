#if defined(tft_480_320)&& defined (openw)&& defined (S4)
...
void S4_time()
{
  ...
  else if (!new_tick && fill_sec)
  {
    ...
    //sec
#if !defined (tft2_S4)
    if (S4 != 0) tft.fillCircle(71, 22, 2, TFT_BLACK);
#endif
  }
  ...
  if (!scr_timer)
  {
    if (refresh_all == true || ref_wh == true)  S4g_show();
